...
//  vars.m_reducedTree -> Branch("PDF_weights_NNPDF20",         "std::vector<float>",         &vars.p_PDF_weights_NNPDF20);
  ...
  vars.m_reducedTree -> Branch("lep_pfChIso", &vars.lep_pfChIso,  "lep_pfChIso/F");
  vars.m_reducedTree -> Branch("lep_pfNhIso", &vars.lep_pfNhIso,  "lep_pfNhIso/F");
  vars.m_reducedTree -> Branch("lep_pfPhIso", &vars.lep_pfPhIso,  "lep_pfPhIso/F");
  ...
  if( doTnP == 1 )
  {
    ...
    vars.m_reducedTree -> Branch("lep2_pfChIso", &vars.lep2_pfChIso,  "lep2_pfChIso/F");
    vars.m_reducedTree -> Branch("lep2_pfNhIso", &vars.lep2_pfNhIso,  "lep2_pfNhIso/F");
    vars.m_reducedTree -> Branch("lep2_pfPhIso", &vars.lep2_pfPhIso,  "lep2_pfPhIso/F");
...
void ClearVBFPreselectionVariables(VBFPreselectionVariables& vars)
{
  ...
  vars.leptons_pfChIso.clear();
  vars.leptons_pfNhIso.clear();
  vars.leptons_pfPhIso.clear();
...
void SetLeptonVariables(VBFPreselectionVariables& vars, treeReader& reader, const int& verbosity)
{
  ...
  vars.lep_pfChIso = vars.leptons_pfChIso.at(vars.selectIt_lep);
  vars.lep_pfNhIso = vars.leptons_pfNhIso.at(vars.selectIt_lep);
  vars.lep_pfPhIso = vars.leptons_pfPhIso.at(vars.selectIt_lep);
...
void SetLepton2Variables(VBFPreselectionVariables& vars, treeReader& reader, const int& verbosity)
{
  ...
  vars.lep2_pfChIso = vars.leptons_pfChIso.at(vars.selectIt_lep2);
  vars.lep2_pfNhIso = vars.leptons_pfNhIso.at(vars.selectIt_lep2);
  vars.lep2_pfPhIso = vars.leptons_pfPhIso.at(vars.selectIt_lep2);
...
void SetElectronVariables(VBFPreselectionVariables& vars, treeReader& reader, const int& eleIt, const int& verbosity)
{
  ...
  vars.leptons_pfChIso.push_back(reader.GetFloat("electrons_chargedHadronIso")->at(eleIt));
  vars.leptons_pfNhIso.push_back(reader.GetFloat("electrons_neutralHadronIso")->at(eleIt));
  vars.leptons_pfPhIso.push_back(reader.GetFloat("electrons_photonIso")->at(eleIt));
...
void SetMuonVariables(VBFPreselectionVariables& vars, treeReader& reader, const int& muIt, const int& verbosity)
{
  ...
  vars.leptons_pfChIso.push_back(reader.GetFloat("muons_chargedHadronIso")->at(muIt));
  vars.leptons_pfNhIso.push_back(reader.GetFloat("muons_neutralHadronIso")->at(muIt));
  vars.leptons_pfPhIso.push_back(reader.GetFloat("muons_photonIso")->at(muIt));
