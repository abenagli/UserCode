...
int main(int argc, char** argv)
{
  ...
  std::cout << ">>>>> Collisions7TeVAnalysis::inputFileList = " << inputFileList << std::endl;
  ...
  histograms -> add_h1("tagJJ_bTag", "",  2000, -100., 100., nStep+1);
  histograms -> add_h1("WJJ_bTag",   "", 2000,  -100., 100., nStep+1);
  ...
  histograms -> add_h1("tagWJ_bTag", "", 2000, -100.,  100., nStep+1);
  histograms -> add_h1("tagWJ_emEnergyFraction", "",  1000,  -1.0,   1.0, nStep+1);
  histograms -> add_h1("tagWJ_etaEtaMoment",     "",  1000,   0.0,   0.1, nStep+1);
  histograms -> add_h1("tagWJ_phiPhiMoment",     "",  1000,   0.0,   0.1, nStep+1);
  histograms -> add_h1("tagWJ_etaPhiMoment",     "",  1000,  -0.1,   0.1, nStep+1);
  histograms -> add_h1("tagWJ_fHPD",             "",  1000,   0.0,   1.0, nStep+1);
  histograms -> add_h1("tagWJ_fRBX",             "",  1000,   0.0,   1.0, nStep+1);
  histograms -> add_h1("tagWJ_n90Hits",          "",   200,   0.0, 200.0, nStep+1);
  ...
  histograms -> add_h1("ele_tkIso_EB",         "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_emIso_EB",         "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_hadIso_EB",        "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_fbrem_EB",         "", 1000,  0.000,  1.000, nStep+1);
  histograms -> add_h1("ele_HoverE_EB",        "", 1000,  0.000,  0.100, nStep+1);
  histograms -> add_h1("ele_DphiIn_EB",        "", 1000, -0.100,  0.100, nStep+1);
  histograms -> add_h1("ele_DetaIn_EB",        "", 1000, -0.015,  0.015, nStep+1);
  histograms -> add_h1("ele_sigmaIetaIeta_EB", "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_dxy_EB",           "", 1000, -0.100,  0.100, nStep+1);
  histograms -> add_h1("ele_dz_EB",            "", 1000, -1.000,  1.000, nStep+1);
  histograms -> add_h1("ele_tkIso_EE",         "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_emIso_EE",         "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_hadIso_EE",        "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_fbrem_EE",         "", 1000,  0.000,  1.000, nStep+1);
  histograms -> add_h1("ele_HoverE_EE",        "", 1000,  0.000,  0.100, nStep+1);
  histograms -> add_h1("ele_DphiIn_EE",        "", 1000, -0.100,  0.100, nStep+1);
  histograms -> add_h1("ele_DetaIn_EE",        "", 1000, -0.015,  0.015, nStep+1);
  histograms -> add_h1("ele_sigmaIetaIeta_EE", "", 1000,  0.000,  0.500, nStep+1);
  histograms -> add_h1("ele_dxy_EE",           "", 1000, -0.100,  0.100, nStep+1);
  histograms -> add_h1("ele_dz_EE",            "", 1000, -1.000,  1.000, nStep+1);
  
  histograms -> add_h1("mu_tkIso",  "", 1000,  0.0, 0.5, nStep+1);
  histograms -> add_h1("mu_emIso",  "", 1000,  0.0, 0.5, nStep+1);
  histograms -> add_h1("mu_hadIso", "", 1000,  0.0, 0.5, nStep+1);
  histograms -> add_h1("mu_dxy",    "", 1000, -0.1, 0.1, nStep+1);
  histograms -> add_h1("mu_dz",     "", 1000, -1.0, 1.0, nStep+1);
  
  histograms -> add_h1("lep_lipSig",  "", 2000, -50.0, 50.0, nStep+1);
  histograms -> add_h1("lep_tipSig",  "", 1000,   0.0, 50.0, nStep+1);  
  histograms -> add_h1("lep_3DipSig", "", 2000, -50.0, 50.0, nStep+1);
  ...
  for(int entry = entryFIRST ; entry < chain -> GetEntries() ; ++entry)
  {
    ...
    {
      //std::cout << reader.GetString("HLT_Names")->at(HLTIt) << std::endl;
    ...
    for(unsigned int eleIt = 0; eleIt < (reader.Get4V("electrons")->size()); ++eleIt)
    {
      ...
      leptons_dxy.push_back(reader.GetFloat("electrons_dxy")->at(eleIt));
      leptons_dz.push_back(reader.GetFloat("electrons_dz")->at(eleIt));
      ...
      electrons_fbrem.push_back(reader.GetFloat("electrons_fbrem")->at(eleIt));
      electrons_HoverE.push_back(reader.GetFloat("electrons_hOverE")->at(eleIt));
      electrons_DphiIn.push_back(reader.GetFloat("electrons_deltaPhiIn")->at(eleIt));
      electrons_DetaIn.push_back(reader.GetFloat("electrons_deltaEtaIn")->at(eleIt));
      electrons_sigmaIetaIeta.push_back(reader.GetFloat("electrons_sigmaIetaIeta")->at(eleIt));
    ...
    for(unsigned int muIt = 0; muIt < (reader.Get4V("muons")->size()); ++muIt)
    {
      ...
      leptons_dxy.push_back(reader.GetFloat("muons_dxy")->at(muIt));
      leptons_dz.push_back(reader.GetFloat("muons_dz")->at(muIt));
    ...
    if(jetType == "Calo")    
      met = reader.Get4V("type1Met")->at(0);
    if(jetType == "PF")    
    ...
    if(leptonFlavours.at(selectIt_lep) == "electron")
    {
      if( fabs(lepton.eta()) < 1.479 )
      {
        histograms -> Fill("ele_tkIso_EB",  step, leptons_tkIso.at(selectIt_lep)/lepton.pt());        
        histograms -> Fill("ele_emIso_EB",  step, leptons_emIso.at(selectIt_lep)/lepton.pt());
        histograms -> Fill("ele_hadIso_EB", step, leptons_hadIso.at(selectIt_lep)/lepton.pt());
        histograms -> Fill("ele_fbrem_EB",  step, electrons_fbrem.at(selectIt_ele));
        histograms -> Fill("ele_HoverE_EB", step, electrons_HoverE.at(selectIt_ele));
        histograms -> Fill("ele_DphiIn_EB", step, electrons_DphiIn.at(selectIt_ele));
        histograms -> Fill("ele_DetaIn_EB", step, electrons_DetaIn.at(selectIt_ele));
        histograms -> Fill("ele_sigmaIetaIeta_EB", step, electrons_sigmaIetaIeta.at(selectIt_ele));
        histograms -> Fill("ele_dxy_EB",           step, leptons_dxy.at(selectIt_lep));
        histograms -> Fill("ele_dz_EB",            step, leptons_dz.at(selectIt_lep));
      }
      else
      {
        histograms -> Fill("ele_tkIso_EE",  step, leptons_tkIso.at(selectIt_lep)/lepton.pt());        
        histograms -> Fill("ele_emIso_EE",  step, leptons_emIso.at(selectIt_lep)/lepton.pt());
        histograms -> Fill("ele_hadIso_EE", step, leptons_hadIso.at(selectIt_lep)/lepton.pt());
        histograms -> Fill("ele_fbrem_EE",  step, electrons_fbrem.at(selectIt_ele));
        histograms -> Fill("ele_HoverE_EE", step, electrons_HoverE.at(selectIt_ele));
        histograms -> Fill("ele_DphiIn_EE", step, electrons_DphiIn.at(selectIt_ele));
        histograms -> Fill("ele_DetaIn_EE", step, electrons_DetaIn.at(selectIt_ele));
        histograms -> Fill("ele_sigmaIetaIeta_EE", step, electrons_sigmaIetaIeta.at(selectIt_ele));
        histograms -> Fill("ele_dxy_EE",           step, leptons_dxy.at(selectIt_lep));
        histograms -> Fill("ele_dz_EE",            step, leptons_dz.at(selectIt_lep));
      }
    }
    if(leptonFlavours.at(selectIt_lep) == "muon")
    {
      histograms -> Fill("mu_tkIso",  step, leptons_tkIso.at(selectIt_lep)/lepton.pt());        
      histograms -> Fill("mu_emIso",  step, leptons_emIso.at(selectIt_lep)/lepton.pt());
      histograms -> Fill("mu_hadIso", step, leptons_hadIso.at(selectIt_lep)/lepton.pt());
      histograms -> Fill("mu_dxy",    step, leptons_dxy.at(selectIt_lep));
      histograms -> Fill("mu_dz",     step, leptons_dz.at(selectIt_lep));
    }
    ...
    for(unsigned int jetIt = 0; jetIt < (reader.Get4V("jets")->size()); ++jetIt)
    {
      ...
      jets_emEnergyFraction.push_back( reader.GetFloat("jets_emEnergyFraction")->at(jetIt) );
      jets_etaEtaMoment.push_back( reader.GetFloat("jets_etaetaMoment")->at(jetIt) );
      jets_phiPhiMoment.push_back( reader.GetFloat("jets_phiphiMoment")->at(jetIt) );
      jets_etaPhiMoment.push_back( reader.GetFloat("jets_etaphiMoment")->at(jetIt) );
      jets_fHPD.push_back( reader.GetFloat("jets_fHPD")->at(jetIt) );
      jets_fRBX.push_back( reader.GetFloat("jets_fRBX")->at(jetIt) );
      jets_n90Hits.push_back( reader.GetFloat("jets_n90Hits")->at(jetIt) );
    ...
    float jet1_tag_emEnergyFraction = jets_emEnergyFraction.at(selectIt_tag.at(0));
    float jet2_tag_emEnergyFraction = jets_emEnergyFraction.at(selectIt_tag.at(1));

    float jet1_tag_etaEtaMoment = jets_etaEtaMoment.at(selectIt_tag.at(0));
    float jet2_tag_etaEtaMoment = jets_etaEtaMoment.at(selectIt_tag.at(1));

    float jet1_tag_phiPhiMoment = jets_phiPhiMoment.at(selectIt_tag.at(0));
    float jet2_tag_phiPhiMoment = jets_phiPhiMoment.at(selectIt_tag.at(1));

    float jet1_tag_etaPhiMoment = jets_etaPhiMoment.at(selectIt_tag.at(0));
    float jet2_tag_etaPhiMoment = jets_etaPhiMoment.at(selectIt_tag.at(1));

    float jet1_tag_fHPD = jets_fHPD.at(selectIt_tag.at(0));
    float jet2_tag_fHPD = jets_fHPD.at(selectIt_tag.at(1));

    float jet1_tag_fRBX = jets_fRBX.at(selectIt_tag.at(0));
    float jet2_tag_fRBX = jets_fRBX.at(selectIt_tag.at(1));

    float jet1_tag_n90Hits = jets_n90Hits.at(selectIt_tag.at(0));
    float jet2_tag_n90Hits = jets_n90Hits.at(selectIt_tag.at(1));
    ...
    float jet1_W_emEnergyFraction = reader.GetFloat("jets_emEnergyFraction")->at(selectIt_W.at(0));
    float jet2_W_emEnergyFraction = reader.GetFloat("jets_emEnergyFraction")->at(selectIt_W.at(1));

    float jet1_W_etaEtaMoment = reader.GetFloat("jets_etaetaMoment")->at(selectIt_W.at(0));
    float jet2_W_etaEtaMoment = reader.GetFloat("jets_etaetaMoment")->at(selectIt_W.at(1));

    float jet1_W_phiPhiMoment = reader.GetFloat("jets_phiphiMoment")->at(selectIt_W.at(0));
    float jet2_W_phiPhiMoment = reader.GetFloat("jets_phiphiMoment")->at(selectIt_W.at(1));

    float jet1_W_etaPhiMoment = reader.GetFloat("jets_etaphiMoment")->at(selectIt_W.at(0));
    float jet2_W_etaPhiMoment = reader.GetFloat("jets_etaphiMoment")->at(selectIt_W.at(1));

    float jet1_W_fHPD = reader.GetFloat("jets_fHPD")->at(selectIt_W.at(0));
    float jet2_W_fHPD = reader.GetFloat("jets_fHPD")->at(selectIt_W.at(1));

    float jet1_W_fRBX = reader.GetFloat("jets_fRBX")->at(selectIt_W.at(0));
    float jet2_W_fRBX = reader.GetFloat("jets_fRBX")->at(selectIt_W.at(1));

    float jet1_W_n90Hits = reader.GetFloat("jets_n90Hits")->at(selectIt_W.at(0));
    float jet2_W_n90Hits = reader.GetFloat("jets_n90Hits")->at(selectIt_W.at(1));
    ...
    histograms -> Fill("tagWJ_bTag", step, jet1_tag_bTag);
    histograms -> Fill("tagWJ_bTag", step, jet2_tag_bTag);    
    histograms -> Fill("tagWJ_bTag", step, jet1_W_bTag);
    histograms -> Fill("tagWJ_bTag", step, jet2_W_bTag);

    histograms -> Fill("tagWJ_emEnergyFraction", step, jet1_tag_emEnergyFraction);
    histograms -> Fill("tagWJ_emEnergyFraction", step, jet2_tag_emEnergyFraction);    
    histograms -> Fill("tagWJ_emEnergyFraction", step, jet1_W_emEnergyFraction);
    histograms -> Fill("tagWJ_emEnergyFraction", step, jet2_W_emEnergyFraction);
        
    histograms -> Fill("tagWJ_etaEtaMoment", step, jet1_tag_etaEtaMoment);
    histograms -> Fill("tagWJ_etaEtaMoment", step, jet2_tag_etaEtaMoment);    
    histograms -> Fill("tagWJ_etaEtaMoment", step, jet1_W_etaEtaMoment);
    histograms -> Fill("tagWJ_etaEtaMoment", step, jet2_W_etaEtaMoment);

    histograms -> Fill("tagWJ_phiPhiMoment", step, jet1_tag_phiPhiMoment);
    histograms -> Fill("tagWJ_phiPhiMoment", step, jet2_tag_phiPhiMoment);    
    histograms -> Fill("tagWJ_phiPhiMoment", step, jet1_W_phiPhiMoment);
    histograms -> Fill("tagWJ_phiPhiMoment", step, jet2_W_phiPhiMoment);
        
    histograms -> Fill("tagWJ_etaPhiMoment", step, jet1_tag_etaPhiMoment);
    histograms -> Fill("tagWJ_etaPhiMoment", step, jet2_tag_etaPhiMoment);    
    histograms -> Fill("tagWJ_etaPhiMoment", step, jet1_W_etaPhiMoment);
    histograms -> Fill("tagWJ_etaPhiMoment", step, jet2_W_etaPhiMoment);
    
    histograms -> Fill("tagWJ_fHPD", step, jet1_tag_fHPD);
    histograms -> Fill("tagWJ_fHPD", step, jet2_tag_fHPD);    
    histograms -> Fill("tagWJ_fHPD", step, jet1_W_fHPD);
    histograms -> Fill("tagWJ_fHPD", step, jet2_W_fHPD);

    histograms -> Fill("tagWJ_fRBX", step, jet1_tag_fRBX);
    histograms -> Fill("tagWJ_fRBX", step, jet2_tag_fRBX);    
    histograms -> Fill("tagWJ_fRBX", step, jet1_W_fRBX);
    histograms -> Fill("tagWJ_fRBX", step, jet2_W_fRBX);
    
    histograms -> Fill("tagWJ_n90Hits", step, jet1_tag_n90Hits);
    histograms -> Fill("tagWJ_n90Hits", step, jet2_tag_n90Hits);    
    histograms -> Fill("tagWJ_n90Hits", step, jet1_W_n90Hits);
    histograms -> Fill("tagWJ_n90Hits", step, jet2_W_n90Hits);
    ...
    //**************************
    // STEP 6 - lepton isolation
    step += 1;
    //std::cout << ">>> step: " << step << std::endl;
    stepName[step] = "6) lepton isolation";
    
    if(leptonFlavours.at(selectIt_lep) == "electron")
    {
      if( fabs(lepton.eta()) < 1.479 )
      {
        if( leptons_tkIso.at(selectIt_lep)/lepton.pt()  > eleTkIsoOverPtEBMAX ) continue;
        if( leptons_emIso.at(selectIt_lep)/lepton.pt() > eleEmIsoOverPtEBMAX ) continue;
        if( leptons_hadIso.at(selectIt_lep)/lepton.pt() > eleHadIsoOverPtEBMAX ) continue;
      }
      else
      {
        if( leptons_tkIso.at(selectIt_lep)/lepton.pt()  > eleTkIsoOverPtEEMAX ) continue;
        if( leptons_emIso.at(selectIt_lep)/lepton.pt() > eleEmIsoOverPtEEMAX ) continue;
        if( leptons_hadIso.at(selectIt_lep)/lepton.pt() > eleHadIsoOverPtEEMAX ) continue;
      }
    }
    if(leptonFlavours.at(selectIt_lep) == "muon")
    {
      //isolation
      if( leptons_tkIso.at(selectIt_lep)/lepton.pt()  > muTkIsoOverPtMAX ) continue;
      if( leptons_emIso.at(selectIt_lep)/lepton.pt() > muEmIsoOverPtMAX ) continue;
      if( leptons_hadIso.at(selectIt_lep)/lepton.pt() > muHadIsoOverPtMAX ) continue;
    }
    ...
    if(leptonFlavours.at(selectIt_lep) == "electron")
    {
      ...
      if( fabs(lepton.eta()) < 1.479 )
      {
        if( electrons_HoverE.at(selectIt_ele) > eleHoverEEBMAX ) continue; 
        if( fabs(electrons_DphiIn.at(selectIt_ele)) > eleDphiInEBMAX ) continue; 
        if( fabs(electrons_DetaIn.at(selectIt_ele)) > eleDetaInEBMAX ) continue; 
        if( electrons_sigmaIetaIeta.at(selectIt_ele) > eleSigmaIetaIetaEBMAX ) continue; 
      }
      else
      {
        if( electrons_HoverE.at(selectIt_ele) > eleHoverEEEMAX ) continue; 
        if( fabs(electrons_DphiIn.at(selectIt_ele)) > eleDphiInEEMAX ) continue; 
        if( fabs(electrons_DetaIn.at(selectIt_ele)) > eleDetaInEEMAX ) continue; 
        if( electrons_sigmaIetaIeta.at(selectIt_ele) > eleSigmaIetaIetaEEMAX ) continue; 
      }
    }
    ...
    //**********************************
    // STEP 12 - Initial cuts - b-tagging
    step += 1;
    //std::cout << ">>> step: " << step << std::endl;
    stepName[step] = "12) b-tagging";
    ...
    //**********************************
    // STEP 13 - Initial cuts - met
    step += 1;
    //std::cout << ">>> step: " << step << std::endl;
    stepName[step] = "13) met";
    ...
    //***************************************
    // STEP 14 - Initial cuts - lepMet - W cut
    step += 1;
    //std::cout << ">>> step: " << step << std::endl;
    stepName[step] = "14) lepMet-W Dphi";
    ...
    //*******************************
    // STEP 15 - Initial cuts - pt max
    step += 1;
    //std::cout << ">>> step: " << step << std::endl;
    stepName[step] = "15) pt max";
    ...
    ////*******************************
    //// STEP 16 - Initial cuts - rapGap
    //step += 1;
    //////std::cout << ">>> step: " << step << std::endl;
    //stepName[step] = "16) rapGap";
    //
    ...
    //  histograms -> Fill("ele_fbrem",         step, electrons_fbrem.at(selectIt_ele));
    //  histograms -> Fill("ele_HoverE",        step, electrons_HoverE.at(selectIt_ele));
    //  histograms -> Fill("ele_DphiIn",        step, electrons_DphiIn.at(selectIt_ele));
    //  histograms -> Fill("ele_DetaIn",        step, electrons_DetaIn.at(selectIt_ele));
    //  if( fabs(lepton.eta()) < 1.479 )
    //    histograms -> Fill("ele_sigmaIetaIeta_EB", step, electrons_sigmaIetaIeta.at(selectIt_ele));
    //  else
    //    histograms -> Fill("ele_sigmaIetaIeta_EE", step, electrons_sigmaIetaIeta.at(selectIt_ele));
    //  histograms -> Fill("ele_dxy",           step, electrons_dxy.at(selectIt_ele));
    //  histograms -> Fill("ele_dz",            step, electrons_dz.at(selectIt_ele));
    //}
    //if(leptonFlavours.at(selectIt_lep) == "muon")
    //{
    ...
    //**********************************************
    // STEP 16 - Initial cuts - higgs transverse mass
    step += 1;
    //std::cout << ">>> step: " << step << std::endl;
    stepName[step] = "16) Higgs mt";
