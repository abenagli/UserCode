...
int main(int argc, char** argv)
{
  ...
  stack -> Draw(histoNames, "eventsScaled", lumi, step, 2., false);
...
//  
  ...
  stack -> Draw(histoNames, "eventsScaled", lumi, step, 5., true);
  ...
  stack -> Draw(histoNames, "eventsScaled", lumi, step, 10., true);
  ...
  stack -> Draw(histoNames, "eventsScaled", lumi, step, 2., true);
  ...
  stack -> Draw(histoNames, "eventsScaled", lumi, step, 1., true);
...
//  stack -> Draw(histoNames, "eventsScaled", lumi, step, 40., true);
//  
