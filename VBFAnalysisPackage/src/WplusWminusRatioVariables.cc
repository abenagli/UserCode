...
void InitializeWplusWminusRatioVariables(WplusWminusRatioVariables& vars, const std::string& name, const int& nStep)
{
  //-----------
  // histograms
  //-----------
...
void DeleteWplusWminusRatioVariables(WplusWminusRatioVariables& vars)
{
