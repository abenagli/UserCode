...
class QGLikelihoodCalculator {
 ...
 public:
  ...
  QGLikelihoodCalculator( const std::string& fileName="/gwpool/users/benaglia/COLLISIONS7TeV/Fall10/NtuplePackage/data/QG_QCD_Pt-15to3000_TuneZ2_Flat_7TeV_pythia6_Summer11-PU_S3_START42_V11-v2.root", unsigned nPtBins=20, unsigned int nRhoBins=17 );
