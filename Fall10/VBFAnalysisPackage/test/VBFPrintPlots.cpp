...
int main(int argc, char** argv)
{
  ...
  int dataRunFlag = gConfigParser -> readIntOption("Options::dataRunFlag");
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 40, PURescale, weightEvent, stackSig);
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 50, PURescale, weightEvent, stackSig);
  ...
  //stack -> SetUnit("");
  //stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 24, PURescale, weightEvent, stackSig);
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 20, PURescale, weightEvent, stackSig);
  ...
  //stack -> SetUnit("cm");
  //stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 250, PURescale, weightEvent, stackSig);
  ...
  stack -> SetUnit("cm");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 30, PURescale, weightEvent, stackSig);
  ...
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 60, PURescale, weightEvent, stackSig);
  ...
  stack -> SetUnit("rad");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi,step, 36, PURescale, weightEvent, stackSig);
  ...
  stack -> SetXaxisTitle("|#eta|(lepton)");
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi,step, 25, PURescale, weightEvent, stackSig);
  ...
  //stack -> SetUnit("");
  //stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi,step, 20, PURescale, weightEvent, stackSig, cuts);
  ...
  stack -> SetUnit("GeV/c");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 60, PURescale, weightEvent, stackSig, cuts);
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi,step, 50, PURescale, weightEvent, stackSig, cuts);
  ...
  stack -> SetUnit("rad");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 40, PURescale, weightEvent, stackSig, cuts);
  ...
  stack -> SetUnit("cm");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 30, PURescale, weightEvent, stackSig, cuts);
  ...
  */
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 80, PURescale, weightEvent, stackSig, cuts);
  ...
  stack -> SetXaxisTitle("3D ip(muon)");
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 100, PURescale, weightEvent, stackSig, cuts);
  ...
  */
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi,step, 10, PURescale, weightEvent, stackSig);
  */
  ...
  */
  ...
  stack -> SetUnit("GeV");
  stack -> Draw(variableNames2, histoName, method, dataRunFlag, lumi, step, 30, PURescale, weightEvent, stackSig);
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames2, histoName, method, dataRunFlag, lumi, step, 50, PURescale, weightEvent, stackSig);
  ...
  //stack -> SetUnit("");
  //stack -> Draw(variableNames2, histoName, method, dataRunFlag, lumi, step, 20, PURescale, weightEvent, stackSig, cuts2);
  ...
  stack -> SetUnit("GeV/c^{2}");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 70, PURescale, weightEvent, stackSig);
  ...
  stack -> SetUnit("GeV/c^{2}");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 35, PURescale, weightEvent, stackSig);
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 36, PURescale, weightEvent, stackSig, cuts);
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames2, histoName, method, dataRunFlag, lumi, step, 50, PURescale, weightEvent, stackSig, cuts2);
  ...
  stack -> SetUnit("");
  stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi, step, 60, PURescale, weightEvent, stackSig, cuts2);
...
//    stack -> SetUnit("");
//    stack -> Draw(variableNames, histoName, method, dataRunFlag, lumi,step, 1., PURescale, weightEvent, stackSig);  
//    
