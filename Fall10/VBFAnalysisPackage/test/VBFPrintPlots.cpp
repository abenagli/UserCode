...
int main(int argc, char** argv)
{
  ...
  //stack -> SetUnit("");
  //stack -> Draw(variableNames, histoName, method, lumi, step, 24, PURescale, weightEvent, stackSig, cuts);
  ...
  //stack -> SetUnit("cm");
  //stack -> Draw(variableNames, histoName, method, lumi, step, 250, PURescale, weightEvent, stackSig, cuts);
  ...
  */
  ...
  stack -> SetUnit("GeV/c^{2}");
  stack -> Draw(variableNames, histoName, method, lumi, step, 35, PURescale, weightEvent, stackSig, cuts);
