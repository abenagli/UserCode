...
readBkg_017.exe rootFileIn flavour[e,mu,emu]
*/
...
int main (int argc, char** argv)
{
  ...
  //EvenHigher
  TH1F * m4_EvenHigher_DY   = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_DY") ;
  TH1F * m4_EvenHigher_TT   = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_TT") ;
  TH1F * m4_EvenHigher_WW   = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_WW") ;
  TH1F * m4_EvenHigher_WZ   = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_WZ") ;
  TH1F * m4_EvenHigher_WJets = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_WJets") ;
  TH1F * m4_EvenHigher_ZZ   = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_ZZ") ;
  TH1F * m4_EvenHigher_top  = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_top") ;
  ...
  if(subtractWJets == false) m4_EvenHigher_total->Add(m4_EvenHigher_WJets);
  ...
  //upper
  TH1F * m4_upper_DY   = (TH1F *) input.Get ( flavour + "_m4_upper_DY") ;
  TH1F * m4_upper_TT   = (TH1F *) input.Get ( flavour + "_m4_upper_TT") ;
  TH1F * m4_upper_WW   = (TH1F *) input.Get ( flavour + "_m4_upper_WW") ;
  TH1F * m4_upper_WZ   = (TH1F *) input.Get ( flavour + "_m4_upper_WZ") ;
  TH1F * m4_upper_WJets = (TH1F *) input.Get ( flavour + "_m4_upper_WJets") ;
  TH1F * m4_upper_ZZ   = (TH1F *) input.Get ( flavour + "_m4_upper_ZZ") ;
  TH1F * m4_upper_top  = (TH1F *) input.Get ( flavour + "_m4_upper_top") ;
  ...
  if(subtractWJets == false) m4_upper_total->Add(m4_upper_WJets);
  ...
  //upper_c
  TH1F * m4_upper_c_DY   = (TH1F *) input.Get ( flavour + "_m4_upper_c_DY") ;
  TH1F * m4_upper_c_TT   = (TH1F *) input.Get ( flavour + "_m4_upper_c_TT") ;
  TH1F * m4_upper_c_WW   = (TH1F *) input.Get ( flavour + "_m4_upper_c_WW") ;
  TH1F * m4_upper_c_WZ   = (TH1F *) input.Get ( flavour + "_m4_upper_c_WZ") ;
  TH1F * m4_upper_c_WJets = (TH1F *) input.Get ( flavour + "_m4_upper_c_WJets") ;
  TH1F * m4_upper_c_ZZ   = (TH1F *) input.Get ( flavour + "_m4_upper_c_ZZ") ;
  TH1F * m4_upper_c_top  = (TH1F *) input.Get ( flavour + "_m4_upper_c_top") ;
  ...
  if(subtractWJets == false) m4_upper_c_total->Add(m4_upper_c_WJets);
  ...
  //upper_a
  TH1F * m4_upper_a_DY   = (TH1F *) input.Get ( flavour + "_m4_upper_a_DY") ;
  TH1F * m4_upper_a_TT   = (TH1F *) input.Get ( flavour + "_m4_upper_a_TT") ;
  TH1F * m4_upper_a_WW   = (TH1F *) input.Get ( flavour + "_m4_upper_a_WW") ;
  TH1F * m4_upper_a_WZ   = (TH1F *) input.Get ( flavour + "_m4_upper_a_WZ") ;
  TH1F * m4_upper_a_WJets = (TH1F *) input.Get ( flavour + "_m4_upper_a_WJets") ;
  TH1F * m4_upper_a_ZZ   = (TH1F *) input.Get ( flavour + "_m4_upper_a_ZZ") ;
  TH1F * m4_upper_a_top  = (TH1F *) input.Get ( flavour + "_m4_upper_a_top") ;
  ...
  if(subtractWJets == false) m4_upper_a_total->Add(m4_upper_a_WJets);
  ...
  //signal
  TH1F * m4_signal_DY   = (TH1F *) input.Get ( flavour + "_m4_signal_DY") ;
  TH1F * m4_signal_TT   = (TH1F *) input.Get ( flavour + "_m4_signal_TT") ;
  TH1F * m4_signal_WW   = (TH1F *) input.Get ( flavour + "_m4_signal_WW") ;
  TH1F * m4_signal_WZ   = (TH1F *) input.Get ( flavour + "_m4_signal_WZ") ;
  TH1F * m4_signal_WJets = (TH1F *) input.Get ( flavour + "_m4_signal_WJets") ;
  TH1F * m4_signal_ZZ   = (TH1F *) input.Get ( flavour + "_m4_signal_ZZ") ;
  TH1F * m4_signal_top  = (TH1F *) input.Get ( flavour + "_m4_signal_top") ;
  ...
  if(subtractWJets == false) m4_signal_total->Add(m4_signal_WJets);
  ...
  if(subtractWJets == false) stack_m4_signal->Add(m4_signal_WJets);
  if(subtractZZ   == false) stack_m4_signal->Add(m4_signal_ZZ);
  if(subtracttop  == false) stack_m4_signal->Add(m4_signal_top);
  
  //lower
  TH1F * m4_lower_DY   = (TH1F *) input.Get ( flavour + "_m4_lower_DY") ;
  TH1F * m4_lower_TT   = (TH1F *) input.Get ( flavour + "_m4_lower_TT") ;
  TH1F * m4_lower_WW   = (TH1F *) input.Get ( flavour + "_m4_lower_WW") ;
  TH1F * m4_lower_WZ   = (TH1F *) input.Get ( flavour + "_m4_lower_WZ") ;
  TH1F * m4_lower_WJets = (TH1F *) input.Get ( flavour + "_m4_lower_WJets") ;
  TH1F * m4_lower_ZZ   = (TH1F *) input.Get ( flavour + "_m4_lower_ZZ") ;
  TH1F * m4_lower_top  = (TH1F *) input.Get ( flavour + "_m4_lower_top") ;
  ...
  if(subtractWJets == false) m4_lower_total->Add(m4_lower_WJets);
  ...
  //lower_c
  TH1F * m4_lower_c_DY   = (TH1F *) input.Get ( flavour + "_m4_lower_c_DY") ;
  TH1F * m4_lower_c_TT   = (TH1F *) input.Get ( flavour + "_m4_lower_c_TT") ;
  TH1F * m4_lower_c_WW   = (TH1F *) input.Get ( flavour + "_m4_lower_c_WW") ;
  TH1F * m4_lower_c_WZ   = (TH1F *) input.Get ( flavour + "_m4_lower_c_WZ") ;
  TH1F * m4_lower_c_WJets = (TH1F *) input.Get ( flavour + "_m4_lower_c_WJets") ;
  TH1F * m4_lower_c_ZZ   = (TH1F *) input.Get ( flavour + "_m4_lower_c_ZZ") ;
  TH1F * m4_lower_c_top  = (TH1F *) input.Get ( flavour + "_m4_lower_c_top") ;
  ...
  if(subtractWJets == false) m4_lower_c_total->Add(m4_lower_c_WJets);
  ...
  //lower_a
  TH1F * m4_lower_a_DY   = (TH1F *) input.Get ( flavour + "_m4_lower_a_DY") ;
  TH1F * m4_lower_a_TT   = (TH1F *) input.Get ( flavour + "_m4_lower_a_TT") ;
  TH1F * m4_lower_a_WW   = (TH1F *) input.Get ( flavour + "_m4_lower_a_WW") ;
  TH1F * m4_lower_a_WZ   = (TH1F *) input.Get ( flavour + "_m4_lower_a_WZ") ;
  TH1F * m4_lower_a_WJets = (TH1F *) input.Get ( flavour + "_m4_lower_a_WJets") ;
  TH1F * m4_lower_a_ZZ   = (TH1F *) input.Get ( flavour + "_m4_lower_a_ZZ") ;
  TH1F * m4_lower_a_top  = (TH1F *) input.Get ( flavour + "_m4_lower_a_top") ;
  ...
  if(subtractWJets == false) m4_lower_a_total->Add(m4_lower_a_WJets);
  ...
  //sideband_total
  TH1F * m4_sideband_DY   = (TH1F *) input.Get ( flavour + "_m4_sideband_DY") ;
  TH1F * m4_sideband_TT   = (TH1F *) input.Get ( flavour + "_m4_sideband_TT") ;
  TH1F * m4_sideband_WW   = (TH1F *) input.Get ( flavour + "_m4_sideband_WW") ;
  TH1F * m4_sideband_WZ   = (TH1F *) input.Get ( flavour + "_m4_sideband_WZ") ;
  TH1F * m4_sideband_WJets = (TH1F *) input.Get ( flavour + "_m4_sideband_WJets") ;
  TH1F * m4_sideband_ZZ   = (TH1F *) input.Get ( flavour + "_m4_sideband_ZZ") ;
  TH1F * m4_sideband_top  = (TH1F *) input.Get ( flavour + "_m4_sideband_top") ;
  ...
  if(subtractWJets == false) m4_sideband_total->Add(m4_sideband_WJets);
  ...
  if(subtractWJets == false) stack_m4_sideband->Add(m4_sideband_WJets);
  if(subtractZZ   == false) stack_m4_sideband->Add(m4_sideband_ZZ);
  if(subtracttop  == false) stack_m4_sideband->Add(m4_sideband_top);
  
  //rebinned signal
  TH1F * m4_signal_reBinned_DY   = (TH1F *) input.Get ( flavour + "_m4_signal_reBinned_DY") ;
  TH1F * m4_signal_reBinned_TT   = (TH1F *) input.Get ( flavour + "_m4_signal_reBinned_TT") ;
  TH1F * m4_signal_reBinned_WW   = (TH1F *) input.Get ( flavour + "_m4_signal_reBinned_WW") ;
  TH1F * m4_signal_reBinned_WZ   = (TH1F *) input.Get ( flavour + "_m4_signal_reBinned_WZ") ;
  TH1F * m4_signal_reBinned_WJets = (TH1F *) input.Get ( flavour + "_m4_signal_reBinned_WJets") ;
  TH1F * m4_signal_reBinned_ZZ   = (TH1F *) input.Get ( flavour + "_m4_signal_reBinned_ZZ") ;
  TH1F * m4_signal_reBinned_top  = (TH1F *) input.Get ( flavour + "_m4_signal_reBinned_top") ;
  ...
  if(subtractWJets == false) m4_signal_total_reBinned->Add(m4_signal_reBinned_WJets);
  ...
  if(subtractWJets == false) stack_m4_signal_reBinned->Add(m4_signal_reBinned_WJets);
  ...
  TH1F * m4_sideband_reBinned_DY   = (TH1F *) input.Get ( flavour + "_m4_sideband_reBinned_DY") ;
  TH1F * m4_sideband_reBinned_TT   = (TH1F *) input.Get ( flavour + "_m4_sideband_reBinned_TT") ;
  TH1F * m4_sideband_reBinned_WW   = (TH1F *) input.Get ( flavour + "_m4_sideband_reBinned_WW") ;
  TH1F * m4_sideband_reBinned_WZ   = (TH1F *) input.Get ( flavour + "_m4_sideband_reBinned_WZ") ;
  TH1F * m4_sideband_reBinned_WJets = (TH1F *) input.Get ( flavour + "_m4_sideband_reBinned_WJets") ;
  TH1F * m4_sideband_reBinned_ZZ   = (TH1F *) input.Get ( flavour + "_m4_sideband_reBinned_ZZ") ;
  TH1F * m4_sideband_reBinned_top  = (TH1F *) input.Get ( flavour + "_m4_sideband_reBinned_top") ;
  ...
  if(subtractWJets == false) m4_sideband_total_reBinned->Add(m4_sideband_reBinned_WJets);
  ...
  if(subtractWJets == false) stack_m4_sideband_reBinned->Add(m4_sideband_reBinned_WJets);
  ...
  THStack * stack_m4_EvenHigher_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_EvenHigher_SIG") ;
  TH1F * m4_EvenHigher_total_SIG = (TH1F*) stack_m4_EvenHigher_SIG->GetStack ()->Last () ;    
  m4_EvenHigher_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_upper_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_upper_SIG") ;
  TH1F * m4_upper_total_SIG = (TH1F*) stack_m4_upper_SIG->GetStack ()->Last () ;
  m4_upper_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_upper_a_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_upper_a_SIG") ;
  TH1F * m4_upper_a_total_SIG = (TH1F*) stack_m4_upper_a_SIG->GetStack ()->Last () ;
  m4_upper_a_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_upper_c_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_upper_c_SIG") ;
  TH1F * m4_upper_c_total_SIG = (TH1F*) stack_m4_upper_c_SIG->GetStack ()->Last () ;
  m4_upper_c_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_lower_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_lower_SIG") ;
  TH1F * m4_lower_total_SIG = (TH1F *) stack_m4_lower_SIG->GetStack ()->Last () ;
  m4_lower_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_lower_a_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_lower_a_SIG") ;
  TH1F * m4_lower_a_total_SIG = (TH1F *) stack_m4_lower_a_SIG->GetStack ()->Last () ;
  m4_lower_a_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_lower_c_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_lower_c_SIG") ;
  TH1F * m4_lower_c_total_SIG = (TH1F *) stack_m4_lower_c_SIG->GetStack ()->Last () ;
  m4_lower_c_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_signal_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_signal_SIG") ;
  TH1F * m4_signal_total_SIG = (TH1F *) stack_m4_signal_SIG->GetStack ()->Last () ;
  m4_signal_total_SIG->SetTitle ("") ;
  
  THStack * stack_m4_sideband_SIG = (THStack *) input.Get ("stack_" + flavour + "_m4_sideband_SIG") ;
  TH1F * m4_sideband_total_SIG = (TH1F *) stack_m4_sideband_SIG->GetStack ()->Last () ;
  m4_sideband_total_SIG->SetTitle ("") ;
  
  //FC get the data
  TH1F * m4_EvenHigher_DATA = (TH1F *) input.Get ( flavour + "_m4_EvenHigher_DATA") ;      
  m4_EvenHigher_DATA->SetTitle ("") ;
  TH1F * m4_upper_DATA = (TH1F *) input.Get ( flavour + "_m4_upper_DATA") ;      
  m4_upper_DATA->SetTitle ("") ;
  TH1F * m4_upper_a_DATA = (TH1F *) input.Get ( flavour + "_m4_upper_a_DATA") ;      
  m4_upper_a_DATA->SetTitle ("") ;
  TH1F * m4_upper_c_DATA = (TH1F *) input.Get ( flavour + "_m4_upper_c_DATA") ;      
  m4_upper_c_DATA->SetTitle ("") ;
  TH1F * m4_signal_DATA = (TH1F *) input.Get ( flavour + "_m4_signal_DATA") ;    
  m4_signal_DATA->SetTitle ("") ;
  TH1F * m4_lower_DATA = (TH1F *) input.Get ( flavour + "_m4_lower_DATA") ;      
  m4_lower_DATA->SetTitle ("") ;
  TH1F * m4_lower_a_DATA = (TH1F *) input.Get ( flavour + "_m4_lower_a_DATA") ;      
  m4_lower_a_DATA->SetTitle ("") ;
  TH1F * m4_lower_c_DATA = (TH1F *) input.Get ( flavour + "_m4_lower_c_DATA") ;      
  m4_lower_c_DATA->SetTitle ("") ;
  TH1F * m4_sideband_DATA = (TH1F *) input.Get ( flavour + "_m4_sideband_DATA") ;
  ...
  { 
    ...
    if(subtractWJets == true) m4_upper_a_DATA->Add (m4_upper_a_WJets, -1);   
    if(subtractWJets == true) m4_lower_a_DATA->Add (m4_lower_a_WJets, -1);
    ...
    if(subtractWJets == true) {
      signalRegionWJets = (TH1F *) m4_upper_c_WJets->Clone ("signalRegionWJets") ;  
      signalRegionWJets->Add (m4_lower_c_WJets) ;
    }
    if(subtractZZ   == true) {
  ...
  if(final)
  {
    ...
    if(subtractWJets == true) m4_sideband_DATA->Add (m4_sideband_WJets, -1) ;
    ...
    if(subtractWJets == true) TH1F * signalRegionWJets = (TH1F *) m4_signal_WJets->Clone ("signalRegionWJets") ;
  ...
  if(subtractWJets == true) { extrapolated_bkg->Add(signalRegionWJets, 1); signalRegionMC->Add(signalRegionWJets, 1);}
  ...
  TFile output ("output_017_" + flavour + ".root", "recreate") ;
  output.cd () ;
