...
//      +-------------------------------  m4
  ...
  //PG calculated with testBkg_013.cpp, 10 events
  Float_t xAxis [94] = {0, 165, 170, 175, 180, 185, 190, 195, 200, 205, 210, 215, 220, 225, 230, 235, 240, 245, 250, 255, 260, 265, 270, 275, 280, 285, 290, 295, 300, 305, 310, 315, 320, 325, 330, 335, 340, 345, 350, 355, 360, 365, 370, 375, 380, 385, 390, 395, 400, 405, 410, 415, 420, 425, 430, 435, 440, 445, 450, 455, 460, 465, 470, 475, 480, 485, 490, 495, 500, 505, 510, 515, 520, 525, 530, 535, 545, 550, 560, 565, 575, 585, 595, 610, 625, 640, 660, 690, 720, 745, 780, 845, 950, 1000} ;
  int nBins = 95 ; //PG xAxis elements minus one

  //PG calculated with testBkg_013.cpp, 20 events
  //Float_t xAxis [79] = {0, 165, 170, 175, 180, 185, 190, 195, 200, 205, 210, 215, 220, 225, 230, 235, 240, 245, 250, 255, 260, 265, 270, 275, 280, 285, 290, 295, 300, 305, 310, 315, 320, 325, 330, 335, 340, 345, 350, 355, 360, 365, 370, 375, 380, 385, 390, 395, 400, 405, 410, 415, 420, 425, 430, 435, 440, 445, 450, 455, 460, 465, 475, 485, 495, 505, 515, 525, 535, 550, 565, 580, 595, 615, 640, 675, 725, 795, 1000} ;
  //  int nBins = 78 ; //PG xAxis elements minus one
...
//  generalCut = generalCut && "lep_flavour == 13" ; //PG only electrons
  std::string outputRootFullFileName = "testBkg_014_S" + mass + ".root" ;
