#ifndef VBFElectronIdSelector_h 
#define VBFElectronIdSelector_h
...
class VBFElectronIdSelector
{
 ...
 private:
  ...
  double m_fbremMIN;
  double m_hcalOverEcalMAX;
  double m_deltaPhiSuperClusterTrackAtVtxMAX;
  double m_deltaEtaSuperClusterTrackAtVtxMAX;
  double m_sigmaIetaIetaMAX;
