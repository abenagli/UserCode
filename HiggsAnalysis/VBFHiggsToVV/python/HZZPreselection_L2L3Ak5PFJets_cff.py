...
from HiggsAnalysis.VBFHiggsToVV.HZZPreselection_all_cff import *
...
VBFNtupleL2L3Ak5PFJets.TauuTag = cms.InputTag("shrinkingConePFTauProducer")
VBFNtupleL2L3Ak5PFJets.doTauRefCheck = cms.untracked.bool(True)
VBFNtupleL2L3Ak5PFJets.TauRefTag = cms.InputTag("VBFSelectedPFTausRefAll")
