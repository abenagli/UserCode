...
VBFNtupleAk5CaloJets.HLTTag = cms.InputTag("TriggerResults::REDIGI")
...
VBFNtupleAk5CaloJets.saveGenJet      = cms.untracked.bool(True)
VBFNtupleAk5CaloJets.saveGenMet      = cms.untracked.bool(True)
VBFNtupleAk5CaloJets.saveMC          = cms.untracked.bool(False)
VBFNtupleAk5CaloJets.saveMCEle       = cms.untracked.bool(True)
VBFNtupleAk5CaloJets.saveMCMu        = cms.untracked.bool(True)
