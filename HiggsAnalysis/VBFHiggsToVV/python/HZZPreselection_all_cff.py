...
from HiggsAnalysis.VBFHiggsToVV.VBFPFTauSelector_cfi import *
VBFSelectedPFTausAll = VBFSelectedPFTaus.clone()
VBFSelectedPFTausRefAll = VBFSelectedPFTausRef.clone()
...
VBFPtMinLeptonCountFilterAll.ptMin  = cms.double(5.)
VBFPtMinLeptonCountFilterAll.etaMin = cms.double(-2.5)
VBFPtMinLeptonCountFilterAll.etaMax = cms.double(+2.5)
VBFPtMinLeptonCountFilterAll.minNumber = cms.int32(3)



# --- THE Z FILTER --- --- --- --- --- --- --- --- --- --- ---

from HiggsAnalysis.VBFHiggsToVV.VBFSameFlavourOppositeSignLeptonFilter_cfi import *
VBFSameFlavourOppositeSignLeptonFilterAll = VBFSameFlavourOppositeSignLeptonFilter.clone()

VBFSameFlavourOppositeSignLeptonFilterAll.srcElectrons = cms.InputTag("VBFConversionRemovalSelectedElectronsAll")
VBFSameFlavourOppositeSignLeptonFilterAll.srcMuons = cms.InputTag("VBFSelectedMuonsAll")
...
VBFPreselectionSequenceAll = cms.Sequence(
    ...
    # taus
    VBFSelectedPFTausAll +
    VBFSelectedPFTausRefAll +
    
    
    
    # lepton filter
    VBFPtMinLeptonCountFilterAll +
    VBFSameFlavourOppositeSignLeptonFilterAll + 
